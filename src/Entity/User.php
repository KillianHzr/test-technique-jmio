...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Selection::class, mappedBy: 'recruiter', orphanRemoval: true)]
    ...
    public function removeSelection(Selection $selection): static
    {
        if ($this->selections->removeElement($selection)) {
            ...
            if ($selection->getRecruiter() === $this) {
                $selection->setRecruiter(null);
            }
        }
