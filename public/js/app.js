document.addEventListener('DOMContentLoaded', () => {
    ...
    master.set('.sidebar, .error-card', { opacity: 0 });
    master.set('.main-view', { opacity: 1, scale: 0.98 });
    master.set('.sidebar__inner, .error-card > *', { opacity: 0, y: 15 });
    master.set('.main-view__header, .main-view__scroll-zone, .main-view__footer', { opacity: 0, y: 16 });
    ...
    if (!isNavigation) {
        ...
        .set('.sidebar, .error-card', { opacity: 1 })
        .to('.intro-overlay', { autoAlpha: 0, duration: 0.3, ease: 'power2.in' })
        .to('.sidebar__inner, .error-card > *', {
            y: 0,
            opacity: 1,
            stagger: 0.08,
            duration: 1,
    ...
    document.addEventListener('click', (e) => {
        ...
        tl.to('.sidebar__inner, .main-view, .error-card > *', {
            opacity: 0,
            duration: 0.4,
            ease: 'power2.inOut'
        })
